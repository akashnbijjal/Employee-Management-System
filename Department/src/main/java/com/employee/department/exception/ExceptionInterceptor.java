...
public class ExceptionInterceptor extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErrorDetails> departmentalreadyexists(DepartmentAlreadyExist ex, WebRequest request)
	...
	public final ResponseEntity<ErrorDetails> departmentnotfound(DepartmentNotFound ex, WebRequest request)
